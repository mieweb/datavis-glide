export default {
  ...
  'GRID.TABLE.SORT_MENU.ADD_TO_SORT': 'Add to Sort',
  'GRID.TABLE.SORT_MENU.ASCENDING': '%s, Ascending',
  'GRID.TABLE.SORT_MENU.DESCENDING': '%s, Descending',
  'GRID.TABLE.SORT_MENU.PRIORITY_BADGE': 'Sort priority %d',
  ...
  'GRID.TITLEBAR.COPY_SELECTION': 'Copy Selection',
  'GRID.TITLEBAR.COPY_SELECTION_CONFIRM': '%d values will be copied to the clipboard. Continue?',
  'GRID.TITLEBAR.COPY_SELECTION_TOOLTIP': 'Copy the selected rows or cells to the clipboard',
  ...
  'GRID.TOAST.CELLS_COPIED': '%d cells copied to clipboard',
  'GRID.TOAST.ROWS_COPIED': '%d rows copied to clipboard',
